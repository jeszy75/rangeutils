...
public class IntRangeCleanTest {
    ...
    void of_Parameterized(int min, int max, int expectedMin, int expectedMax) {
    ...
    @Test
    void contains_WithinAndOutsideRange() {
    ...
    @Test
    void containsRange_SubRangesAndEmpty() {
    ...
    @Test
    void containsRange_OverlappingAndLargerRanges() {
